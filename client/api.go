...
import (
	...
	"github.com/tabeo/stripe-go/v71/account"
	"github.com/tabeo/stripe-go/v71/accountlink"
	"github.com/tabeo/stripe-go/v71/applepaydomain"
	"github.com/tabeo/stripe-go/v71/balance"
	"github.com/tabeo/stripe-go/v71/balancetransaction"
	"github.com/tabeo/stripe-go/v71/bankaccount"
	billingportalsession "github.com/tabeo/stripe-go/v71/billingportal/session"
	"github.com/tabeo/stripe-go/v71/bitcoinreceiver"
	"github.com/tabeo/stripe-go/v71/bitcointransaction"
	"github.com/tabeo/stripe-go/v71/capability"
	"github.com/tabeo/stripe-go/v71/card"
	"github.com/tabeo/stripe-go/v71/charge"
	checkoutsession "github.com/tabeo/stripe-go/v71/checkout/session"
	"github.com/tabeo/stripe-go/v71/countryspec"
	"github.com/tabeo/stripe-go/v71/coupon"
	"github.com/tabeo/stripe-go/v71/creditnote"
	"github.com/tabeo/stripe-go/v71/customer"
	"github.com/tabeo/stripe-go/v71/customerbalancetransaction"
	"github.com/tabeo/stripe-go/v71/discount"
	"github.com/tabeo/stripe-go/v71/dispute"
	"github.com/tabeo/stripe-go/v71/ephemeralkey"
	"github.com/tabeo/stripe-go/v71/event"
	"github.com/tabeo/stripe-go/v71/exchangerate"
	"github.com/tabeo/stripe-go/v71/fee"
	"github.com/tabeo/stripe-go/v71/feerefund"
	"github.com/tabeo/stripe-go/v71/file"
	"github.com/tabeo/stripe-go/v71/filelink"
	"github.com/tabeo/stripe-go/v71/invoice"
	"github.com/tabeo/stripe-go/v71/invoiceitem"
	"github.com/tabeo/stripe-go/v71/issuing/authorization"
	issuingcard "github.com/tabeo/stripe-go/v71/issuing/card"
	"github.com/tabeo/stripe-go/v71/issuing/cardholder"
	issuingdispute "github.com/tabeo/stripe-go/v71/issuing/dispute"
	"github.com/tabeo/stripe-go/v71/issuing/transaction"
	"github.com/tabeo/stripe-go/v71/loginlink"
	"github.com/tabeo/stripe-go/v71/mandate"
	"github.com/tabeo/stripe-go/v71/oauth"
	"github.com/tabeo/stripe-go/v71/order"
	"github.com/tabeo/stripe-go/v71/orderreturn"
	"github.com/tabeo/stripe-go/v71/paymentintent"
	"github.com/tabeo/stripe-go/v71/paymentmethod"
	"github.com/tabeo/stripe-go/v71/paymentsource"
	"github.com/tabeo/stripe-go/v71/payout"
	"github.com/tabeo/stripe-go/v71/person"
	"github.com/tabeo/stripe-go/v71/plan"
	"github.com/tabeo/stripe-go/v71/price"
	"github.com/tabeo/stripe-go/v71/product"
	"github.com/tabeo/stripe-go/v71/radar/earlyfraudwarning"
	"github.com/tabeo/stripe-go/v71/radar/valuelist"
	"github.com/tabeo/stripe-go/v71/radar/valuelistitem"
	"github.com/tabeo/stripe-go/v71/recipient"
	"github.com/tabeo/stripe-go/v71/refund"
	"github.com/tabeo/stripe-go/v71/reporting/reportrun"
	"github.com/tabeo/stripe-go/v71/reporting/reporttype"
	"github.com/tabeo/stripe-go/v71/reversal"
	"github.com/tabeo/stripe-go/v71/review"
	"github.com/tabeo/stripe-go/v71/setupintent"
	"github.com/tabeo/stripe-go/v71/sigma/scheduledqueryrun"
	"github.com/tabeo/stripe-go/v71/sku"
	"github.com/tabeo/stripe-go/v71/source"
	"github.com/tabeo/stripe-go/v71/sourcetransaction"
	"github.com/tabeo/stripe-go/v71/sub"
	"github.com/tabeo/stripe-go/v71/subitem"
	"github.com/tabeo/stripe-go/v71/subschedule"
	"github.com/tabeo/stripe-go/v71/taxid"
	"github.com/tabeo/stripe-go/v71/taxrate"
	terminalconnectiontoken "github.com/tabeo/stripe-go/v71/terminal/connectiontoken"
	terminallocation "github.com/tabeo/stripe-go/v71/terminal/location"
	terminalreader "github.com/tabeo/stripe-go/v71/terminal/reader"
	"github.com/tabeo/stripe-go/v71/threedsecure"
	"github.com/tabeo/stripe-go/v71/token"
	"github.com/tabeo/stripe-go/v71/topup"
	"github.com/tabeo/stripe-go/v71/transfer"
	"github.com/tabeo/stripe-go/v71/usagerecord"
	"github.com/tabeo/stripe-go/v71/usagerecordsummary"
	"github.com/tabeo/stripe-go/v71/webhookendpoint"
)
