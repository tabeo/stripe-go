...
import (
	...
	"github.com/tabeo/stripe-go/account"
	"github.com/tabeo/stripe-go/accountlink"
	"github.com/tabeo/stripe-go/applepaydomain"
	"github.com/tabeo/stripe-go/balance"
	"github.com/tabeo/stripe-go/balancetransaction"
	"github.com/tabeo/stripe-go/bankaccount"
	billingportalsession "github.com/tabeo/stripe-go/billingportal/session"
	"github.com/tabeo/stripe-go/bitcoinreceiver"
	"github.com/tabeo/stripe-go/bitcointransaction"
	"github.com/tabeo/stripe-go/capability"
	"github.com/tabeo/stripe-go/card"
	"github.com/tabeo/stripe-go/charge"
	checkoutsession "github.com/tabeo/stripe-go/checkout/session"
	"github.com/tabeo/stripe-go/countryspec"
	"github.com/tabeo/stripe-go/coupon"
	"github.com/tabeo/stripe-go/creditnote"
	"github.com/tabeo/stripe-go/customer"
	"github.com/tabeo/stripe-go/customerbalancetransaction"
	"github.com/tabeo/stripe-go/discount"
	"github.com/tabeo/stripe-go/dispute"
	"github.com/tabeo/stripe-go/ephemeralkey"
	"github.com/tabeo/stripe-go/event"
	"github.com/tabeo/stripe-go/exchangerate"
	"github.com/tabeo/stripe-go/fee"
	"github.com/tabeo/stripe-go/feerefund"
	"github.com/tabeo/stripe-go/file"
	"github.com/tabeo/stripe-go/filelink"
	"github.com/tabeo/stripe-go/invoice"
	"github.com/tabeo/stripe-go/invoiceitem"
	"github.com/tabeo/stripe-go/issuing/authorization"
	issuingcard "github.com/tabeo/stripe-go/issuing/card"
	"github.com/tabeo/stripe-go/issuing/cardholder"
	issuingdispute "github.com/tabeo/stripe-go/issuing/dispute"
	"github.com/tabeo/stripe-go/issuing/transaction"
	"github.com/tabeo/stripe-go/loginlink"
	"github.com/tabeo/stripe-go/mandate"
	"github.com/tabeo/stripe-go/oauth"
	"github.com/tabeo/stripe-go/order"
	"github.com/tabeo/stripe-go/orderreturn"
	"github.com/tabeo/stripe-go/paymentintent"
	"github.com/tabeo/stripe-go/paymentmethod"
	"github.com/tabeo/stripe-go/paymentsource"
	"github.com/tabeo/stripe-go/payout"
	"github.com/tabeo/stripe-go/person"
	"github.com/tabeo/stripe-go/plan"
	"github.com/tabeo/stripe-go/price"
	"github.com/tabeo/stripe-go/product"
	"github.com/tabeo/stripe-go/promotioncode"
	"github.com/tabeo/stripe-go/radar/earlyfraudwarning"
	"github.com/tabeo/stripe-go/radar/valuelist"
	"github.com/tabeo/stripe-go/radar/valuelistitem"
	"github.com/tabeo/stripe-go/recipient"
	"github.com/tabeo/stripe-go/refund"
	"github.com/tabeo/stripe-go/reporting/reportrun"
	"github.com/tabeo/stripe-go/reporting/reporttype"
	"github.com/tabeo/stripe-go/reversal"
	"github.com/tabeo/stripe-go/review"
	"github.com/tabeo/stripe-go/setupintent"
	"github.com/tabeo/stripe-go/sigma/scheduledqueryrun"
	"github.com/tabeo/stripe-go/sku"
	"github.com/tabeo/stripe-go/source"
	"github.com/tabeo/stripe-go/sourcetransaction"
	"github.com/tabeo/stripe-go/sub"
	"github.com/tabeo/stripe-go/subitem"
	"github.com/tabeo/stripe-go/subschedule"
	"github.com/tabeo/stripe-go/taxid"
	"github.com/tabeo/stripe-go/taxrate"
	terminalconnectiontoken "github.com/tabeo/stripe-go/terminal/connectiontoken"
	terminallocation "github.com/tabeo/stripe-go/terminal/location"
	terminalreader "github.com/tabeo/stripe-go/terminal/reader"
	"github.com/tabeo/stripe-go/threedsecure"
	"github.com/tabeo/stripe-go/token"
	"github.com/tabeo/stripe-go/topup"
	"github.com/tabeo/stripe-go/transfer"
	"github.com/tabeo/stripe-go/usagerecord"
	"github.com/tabeo/stripe-go/usagerecordsummary"
	"github.com/tabeo/stripe-go/webhookendpoint"
)
